...
$(".box").click(function(e) {
    ...
    const showMaps = myMaps.filter(function(map){
        if(clickedId === map.id)return map;
    });
...
function clickedObject(whatObject){
    console.log(whatObject[0]) 
          ...
          document.getElementById("venuename").innerHTML = whatObject[0].name;
          document.getElementById("bodytext").innerHTML = whatObject[0].about;
          document.getElementById("weblink").href = whatObject[0].website;
   }
